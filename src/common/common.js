...
export function setBtnClickFuc() {
  //userid roomid规格
...
export function setCameraId(thisDiv) {
  cameraId = $(thisDiv).attr("id");
  console.log("setCameraId: " + cameraId);
}

export function setMicId(thisDiv) {
  micId = $(thisDiv).attr("id");
  console.log("setMicId: " + micId);
}

export function addVideoView(id, isLocal = false) {
  let div = $("<div/>", {
    id: id,
    class: "video-box",
...
export function addMemberView(id) {
  let memberElm = $("#member-me").clone();
  console.log(1, memberElm);
  memberElm.attr("id", id);
  console.log(2, memberElm);
  memberElm.find("div.member-id").html(id);
  console.log(3, memberElm);
  memberElm.css("display", "flex");
  console.log(4, memberElm);
  memberElm.appendTo($("#member-list"));
  console.log(5, $("#member-list"));
}
...
export function exchangeView(a, b) {
  var $div1 = $(a);
  var $div3 = $(b);
  var $temobj1 = $("<div></div>");
  var $temobj2 = $("<div></div>");
